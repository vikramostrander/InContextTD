...
python3 main.py -config=boyan --representable -model=tf -l=3 --activation=softmax --mode=sequential --suffix=bc_tf_l3_seq
...
python3 main.py -config=cartpole --representable -model=tf -l=3 --activation=softmax --mode=sequential --suffix=cp_tf_seq
...
python3 main.py -config=mountaincar --representable -model=tf -l=3 --activation=softmax --mode=sequential --suffix=mc_tf_l3_seq
